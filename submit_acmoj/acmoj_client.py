...
def main():
    ...
    submit_file_parser = subparsers.add_parser("submit-file", help="Submit a local code file (content)")
    ...
    submit_file_parser.add_argument("--language", type=str, default="cpp", help="Language for submission (default: cpp)")
